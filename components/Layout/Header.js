  ...
  return (
    <div className="sticky top-0 z-50 py-4 px-6 bg-[#373636] border-b border-[#545252]">
      <div className="flex items-center justify-between ">
        <div className={`flex items-center justify-between ${user ? 'gap-8 w-6/12' : ''}`}>
          <button
            className="md:hidden items-center justify-between p-3 flex rounded-full bg-[#3F3F3F]"
        ...
        <div className="flex items-center gap-8">
          {user ? (
            <button
              className="bg-transparent border border-[#545252] transition ease-in duration-200 text-white px-5 py-2 flex justify-start items-center gap-4 rounded-full"
