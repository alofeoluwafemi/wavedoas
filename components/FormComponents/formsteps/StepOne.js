    ...
    <>
      <div className="fade-in">
        ...
        <form>
          <div className="space-y-7">
            ...
            <div className="w-full">
              ...
              <input
                ...
                className="bg-transparent border w-full h-12 border-[#545252] text-sm rounded-3xl px-4 py-3 text-[#A4A1A1] focus:outline-none "
              />
            </div>
            ...
            <div>
              ...
              <div className="flex mb-6">
                <div className="rounded-full mr-6 bg-lyt w-12 h-12 flex items-center justify-center">
                  <img alt="" className="border rounded" src="/gallery.svg" />
                </div>
            ...
            <div className="w-full">
              ...
              <input
                ...
                className="bg-transparent border w-full h-12 border-[#545252]  rounded-3xl px-4 py-3 text-[#A4A1A1] text-sm focus:outline-none "
              />
            </div>
                ...
                <div className="mt-1 relative rounded-full flex-1 bg-transparent items-center grow flex h-14 w-full  ">
                  <div className="absolute inset-y-0 left-0 px-3 flex items-center pointer-events-none h-full">
                    <span className="text-gray-500 px-3 w-22 h-22">
                      <img alt="" src="/github.svg" className="w-full h-full" />
                    </span>
                  </div>
                  <input
          ...
          <button onClick={() => handleClick('next')} className="button1 h-12 w-full m-auto rounded-3xl">
